...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/kevinliu/Desktop/QBIO_490/QBIO_490_kevinliu")) 
```
...
age <- 19
birthday <- "12/18/2003"
three_fav_colors <- c("blue", "green", "orange")
...
colnames(mtcars)
rownames(mtcars)
mtcars_new <- mtcars[c(1:32), c(1:8, 10:12)]
```
